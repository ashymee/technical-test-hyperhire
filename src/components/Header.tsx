...
export default function Header() {
  ...
  return (
    <header
      className={`w-full h-[60] fixed top-0 flex items-center justify-center text-white z-[99] transition-all px-4 2xl:px-0 ${
      ...
      <div className="w-full 2xl:w-[1200] flex items-center justify-between">
        ...
        <div className="hidden md:flex gap-10">
          <div className="group relative cursor-pointer">
            ...
            <div className="absolute -z-50 group-hover:z-10 -top-[150] group-hover:top-10 left-1/2 transform -translate-x-1/2 opacity-10 group-hover:opacity-100 transition-all delay-500">
              <div className="w-max px-8 py-4 bg-white rounded-xl flex flex-col items-start justify-center text-[#344054] shadow-2xl">
                <div className="font-poppins font-extrabold text-[14]">채용</div>
                <Link className="text-[14] opacity-75 hover:opacity-100" href="/">
                  해외 개발자 원격 채용
                </Link>
                <Link className="text-[14] opacity-75 hover:opacity-100" href="/">
                  외국인 원격 채용 (비개발 직군)
        ...
        <div className="w-[115] hidden md:flex items-start justify-end">
          <button
            type="button"
